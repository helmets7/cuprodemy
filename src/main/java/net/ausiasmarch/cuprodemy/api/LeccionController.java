...
public class LeccionController {
    ...
    public ResponseEntity<Page<LeccionEntity>> getPage(
        ...
        return new ResponseEntity<Page<LeccionEntity>>(oLeccionService.getPage(oPageable, strFilter, sDescripcion), HttpStatus.OK);
    }
    ...
    public ResponseEntity<LeccionEntity> generate() {
        return new ResponseEntity<LeccionEntity>(oLeccionService.generate(), HttpStatus.OK);
    }
}
