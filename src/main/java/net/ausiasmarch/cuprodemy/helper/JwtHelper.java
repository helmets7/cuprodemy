package net.ausiasmarch.cuprodemy.helper;
...
import net.ausiasmarch.cuprodemy.exception.JWTException;


public class JwtHelper {

    private static final String SECRET = "Cuprodemy2022cuprodemY2023";
    private static final String ISSUER = "CUPRODEMY";
